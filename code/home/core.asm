...
@clear_nt:
    ...
    /* C266 A6 01    */ ldx zR01
    /* C268 CA       */ dex
    /* C269 BD 84 C2 */ lda @ppu_nt_hiaddr_lut.w, X
...
BatchPPUTransfer@lop:
    ...
    /* C3CB 0A       */ asl A
    /* C3CC 20 F3 C3 */ jsr BatchPPUTransfer@set_transfer_mode
    ...
    /* C3D5 90 01    */ bcc BatchPPUTransfer@lop_write

    /* C3D7 C8       */ iny

BatchPPUTransfer@lop_write:
    /* C3D8 B0 01    */ bcs +
...
+:
    ...
    /* C3E0 CA       */ dex
    /* C3E1 D0 F5    */ bne BatchPPUTransfer@lop_write
...
PutTransferWTsa:
    ...
    /* C450 4C 74 C4 */ jmp PutTransferRectCore
...
@lop_y:
    ...
    /* C476 20 A2 C4 */ jsr PutTransferByte

    /* C479 A5 00    */ lda zR00
    /* C47B 20 A2 C4 */ jsr PutTransferByte

    /* C47E A5 05    */ lda zR05
    /* C480 85 06    */ sta zR06
    /* C482 20 A2 C4 */ jsr PutTransferByte

@lop_x:
    /* C485 C8       */ iny
    /* C486 B1 02    */ lda (zR02), Y
    /* C488 20 A2 C4 */ jsr PutTransferByte
...
IncTransferCnt:
    /* C4A5 E8       */ inx
    /* C4A6 E0 5F    */ cpx #$5F
    /* C4A8 90 0A    */ bcc EndTransfer@end
...
@LOC_C4C8:
    /* C4C8 85 04    */ sta zR04
    /* C4CA A5 01    */ lda zR01
    /* C4CC 20 A2 C4 */ jsr PutTransferByte

    /* C4CF A5 00    */ lda zR00
    /* C4D1 20 A2 C4 */ jsr PutTransferByte
...
+:
    ...
    /* C4E5 20 A2 C4 */ jsr PutTransferByte
...
FUNC_C509:
    ...
    /* C514 4C A5 C4 */ jmp IncTransferCnt
...
CaseRet: ; why is this here I have no idea
    /* C73D 60       */ rts
...
@lop
    ...
    /* C780 29 80    */ and #PPUSTATUS.vblank
    /* C782 D0 F9    */ bne @lop
...
FUNC_C81C:
    ...
    /* C82D C9 27    */ cmp #$27
    /* C82F D0 10    */ bne @LOC_C841

@LOC_C831:
    /* C831 A5 00    */ lda zR00
    /* C833 C9 C0    */ cmp #$C0
    /* C835 90 0A    */ bcc @LOC_C841
...
CallFarFunc:
    ...
    /* CA0C BD A0 BF */ lda EVERYBANK_FARFUNCS, X
    /* CA0F 85 45    */ sta zFarFuncPtr
    /* CA11 BD A1 BF */ lda EVERYBANK_FARFUNCS+1, X
...
PutSprite:
    ...
    /* CA26 B9 D0 BF */ lda EVERYBANK_SPRITEGROUPS, Y
    /* CA29 85 40    */ sta zUnk40
    /* CA2B B9 D1 BF */ lda EVERYBANK_SPRITEGROUPS+1, Y
