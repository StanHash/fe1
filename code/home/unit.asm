...
@begin:
    ...
    /* F0FB A0 10    */ ldy #Unit.y
    /* F0FD B1 00    */ lda (zR00), Y

    /* F0FF C5 02    */ cmp zR02
    /* F101 D0 DA    */ bne @lop

    /* F103 A0 11    */ ldy #Unit.x
...
FUNC_F19F:
    ...
    /* F1AE 4A       */ lsr A
    /* F1AF A8       */ tay
    /* F1B0 BD B7 F1 */ lda DAT_F1B7.w, X
...
DAT_F1B7:
    /* F1B7 ...      */ .db $01, $02, $04, $08, $10, $20, $40, $80
