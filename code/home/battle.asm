...
@lop_battler:
    ...
    /* CBF5 7D 6B D7 */ adc ItemInfo.hit.w, X
...
@magic_hit:
    ...
    /* CC3C BD 6B D7 */ lda ItemInfo.hit.w, X
    /* CC3F 38       */ sec
...
@lop_battler:
    ...
    /* CC55 38       */ sec
    /* CC56 FD 0F D7 */ sbc ItemInfo.weight.w, X
    /* CC59 10 02    */ bpl +
...
@lop_battler:
    ...
    /* CC74 7D 57 D6 */ adc ItemInfo.might.w, X
    /* CC77 85 08    */ sta zR08

    /* CC79 BD 57 D6 */ lda ItemInfo.might.w, X
    /* CC7C 99 49 03 */ sta wFightMight, Y

    /* CC7F BD DB D8 */ lda ItemInfo.effectiveness.w, X
    ...
    /* CC89 A5 08    */ lda zR08
    /* CC8B 18       */ clc
    /* CC8C 7D 57 D6 */ adc ItemInfo.might.w, X
    /* CC8F 7D 57 D6 */ adc ItemInfo.might.w, X
    /* CC92 85 08    */ sta zR08
    /* CC94 B9 49 03 */ lda wFightMight, Y
    /* CC97 18       */ clc
    /* CC98 7D 57 D6 */ adc ItemInfo.might.w, X
    /* CC9B 7D 57 D6 */ adc ItemInfo.might.w, X
...
@magic:
    /* CCBF BD 57 D6 */ lda ItemInfo.might.w, X
...
@lop_battler:
    ...
    /* CD23 18       */ clc
    /* CD24 7D C7 D7 */ adc ItemInfo.crit.w, X
    /* CD27 4A       */ lsr A
...
@lop_battler:
    ...
    /* CD53 BD C3 D9 */ lda ItemInfo.Unk_D9C3.w, X
...
@LOC_CD5D:
    ...
    /* CD63 BD C3 D9 */ lda ItemInfo.Unk_D9C3.w, X
...
FUNC_CDA9:
    ...
    /* CDB8 A2 03    */ ldx #_sizeof_DAT_CDD0-1

@lop:
    /* CDBA DD D0 CD */ cmp DAT_CDD0.w, X
...
@LOC_CEE1:
    ...
    /* CEE9 BD C3 D9 */ lda ItemInfo.Unk_D9C3.w, X
...
@LOC_CEF3:
    ...
    /* CEF6 BD C3 D9 */ lda ItemInfo.Unk_D9C3.w, X
...
@spr0_hit_await:
    ...
    /* CF1B 29 40    */ and #PPUSTATUS.spr0_hit
    /* CF1D D0 F9    */ bne @spr0_hit_await

@spr0_hit_await_end:
    /* CF1F AD 02 20 */ lda PPUSTATUS
    /* CF22 29 40    */ and #PPUSTATUS.spr0_hit
...
FUNC_CF45:
    ...
    /* CF48 A0 00    */ ldy #0
    /* CF4A F0 02    */ beq FUNC_CF4C@LOC_CF4E
...
GetBattlerStatPointers:
    ...
    /* D052 BD 69 D0 */ lda @battler_stat_before_addr_lut.w, X
    /* D055 85 04    */ sta zR04
    /* D057 BD 6A D0 */ lda @battler_stat_before_addr_lut.w+1, X
    /* D05A 85 05    */ sta zR04+1

    /* D05C BD 77 D0 */ lda @battler_stat_after_addr_lut.w, X
    /* D05F 85 08    */ sta zR08
    /* D061 BD 78 D0 */ lda @battler_stat_after_addr_lut.w+1, X
...
@battler_stat_before_addr_lut:
    /* D069 ...      */ .dw wFightStrength, wFightSkill, wFight0316, wFightSpeed
    /* D071 ...      */ .dw wFightLuck, wFightDefense, wFightMaxHp

@battler_stat_after_addr_lut:
    /* D077 ...      */ .dw wFight032C, wFight032D, wFight032E, wFight032F
    /* D07F ...      */ .dw wFight0330, wFight0331, wFight032A

FightCheckForLevelGain:
...
@lop_stats:
    ...
    /* D0DE B9 E0 E1 */ lda CharacterGrowthTable.w, Y
    /* D0E1 85 06    */ sta zR06
    /* D0E3 B9 E1 E1 */ lda CharacterGrowthTable.w+1, Y
...
CheckMercuriusStatGainBonus:
    ...
    /* D122 BD 2F D1 */ lda @mask_lut.w, X
...
FUNC_D156:
    /* D156 BD 67 D9 */ lda ItemInfo.effect.w, X
...
@case_effect_08:
    ...
    /* D249 B9 7F D8 */ lda ItemInfo.uses.w, Y
    /* D24C 8D 25 03 */ sta $0325
...
@LOC_D253:
    ...
    /* D256 B9 B3 D6 */ lda ItemInfo.weapon_level.w, Y
...
FUNC_D2C7:
    ...
    /* D2D5 BD C3 D9 */ lda ItemInfo.Unk_D9C3.w, X
...
@LOC_D2DC:
    ...
    /* D2E2 BD C3 D9 */ lda ItemInfo.Unk_D9C3.w, X
...
IsEffective:
    ...
    /* D2F4 0A       */ asl A
    /* D2F5 AA       */ tax
    /* D2F6 BD 37 D9 */ lda EffectivenessInfo.w, X
    /* D2F9 85 00    */ sta zR00
    /* D2FB BD 38 D9 */ lda EffectivenessInfo.w+1, X
